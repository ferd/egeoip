...
get_record(D=#geoipdb{record_length = Length,
    ...
    #geoip{country_code = Country,
           ...
           country_name = unicode:characters_to_binary(CountryName, latin1, utf8),
           region = unicode:characters_to_binary(Region, latin1, utf8),
           city = unicode:characters_to_binary(City, latin1, utf8),
           postal_code = Postal,
           latitude = Lat,
           longitude = Lon,
           dma_code = DmaCode,
